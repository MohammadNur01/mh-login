...
class Auth extends CI_Controller
{
  ...
  public function registration()
  {
    ...
    if ($this->form_validation->run() == false) {
      $data['title'] = 'MH User Registration';
      $this->load->view('templates/auth_header', $data);
      ...
      $this->session->set_flashdata('message', '<div class="alert alert-success" role="alert">Congratulation, your account has been created. Please check your email to activated!</div>');
      redirect('auth');
    }
  }
